...
/*--------CRC--------*/
const unsigned char     ceres_crc_table[] =
{
...
inline unsigned char    ceres_crc_calc(unsigned char* frame, int* len);
...
/*--------CIPHER--------*/
inline unsigned char    ceres_msg_keygen();

inline void             ceres_base_transform(unsigned char* frame, int* len, unsigned char* global_key);

inline void             ceres_additional_transform(unsigned char* frame, int* len, unsigned char* global_key, unsigned char cmd);
